...
\newcommand{\namesection}[2]{
	\centering{
		\fontsize{20pt}{22pt} 
		\fontspec[Path = fonts/georgia/]{georgiab}\selectfont #1 \vspace{1ex}
	} \\
...
\newcommand{\sectionsep}{\vspace{11pt}}
\newcommand{\postsectionsep}{\vspace{1ex}}
...
\titleformat{\subsection}{
	\fontspec[Path = fonts/lato/]{Lato-Bol}\fontsize{12pt}{12pt}\selectfont \bfseries
}{}{0em}{}

\newcommand{\position}[2]{
	\fontspec[Path = fonts/lato/]{Lato-RegIta}\fontsize{11pt}{11.5pt}\selectfont
	\textit{\textbf{#1}} \normalfont \hfill #2 \\
}
\newcommand{\institution}[2]{
	\fontspec[Path = fonts/lato/]{Lato-RegIta}\fontsize{12pt}{12.5pt}\selectfont
	\textit{\textbf{#1}} \normalfont \hfill #2 \\
}
